        ...
        <div className="fixed inset-0 flex items-center justify-center bg-[#000000ab] bg-opacity-50 z-2">
            <div className="bg-[#022a52] w-[50%] p-5 rounded-md shadow-lg text-white relative">
                ...
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-[26px] font-semibold">Descrizione</h2>
                ...
                <div className="mt-4 text-sm">
                    <p>
                        Buon sostituto per guarnizione vecchia o danneggiata, guarnizione della testata .
                        </p>
                    <p>
                        Il motore fuoribordo a 4 tempi da 6,5 CV offre potenza sufficiente per guidare la nave a una velocità molto elevata. Sarà il tuo assistente più forte quando navighi in mare. Dettagli: Deflettore d'acqua: il deflettore d'acqua sopra l'elica riduce efficacemente il lancio delle onde e impedisce all'acqua di bagnare i vestiti
                    </p>
                </div>
