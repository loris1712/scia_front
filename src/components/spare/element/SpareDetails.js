  ...
  return (
    ...
    <div className="grid sm:grid-cols-2 gap-4 px-2">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center mb-2">
          <h2 className="text-lg text-[#789fd6]">{t("original_name")}</h2>
        </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center mb-2">
          <h2 className="text-lg text-[#789fd6]">{t("orders")}</h2>
        </div>
    ...
    {details && details[0].NCAGE > 0 && 
      <div className="mb-6">
        ...
        <div className="flex items-center mb-2">
          <h2 className="text-lg text-[#789fd6]">Part Number {t("costructor")}</h2>
        </div>
