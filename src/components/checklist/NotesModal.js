    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-10">
      <div className="bg-[#022a52] sm:w-[50%] w-full p-6 rounded-md shadow-lg text-white">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-[22px] font-semibold">Note: {data.element_eswbs_instance_id}</h2>
        ...
        <div>
            <p className="text-[#789fd6] mb-4">Note fotografiche</p>
        ...
        <div className="mt-6">
            <p className="text-[#789fd6] mb-4">Note vocali</p>
