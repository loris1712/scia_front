      ...
      <div className="bg-[#022a52] w-[70%] p-5 rounded-md shadow-lg text-white">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <input type="password" placeholder={t("old_password")} value={oldPassword} onChange={(e) => setOldPassword(e.target.value)} className="w-full px-4 py-2 bg-[#ffffff10] text-white focus:outline-none mt-2" />
          </div>
          <div>
            <label className="text-[#789FD6] text-sm">{t("new_password")}</label>
            <input type="password" placeholder={t("new_password")} value={newPassword} onChange={(e) => setNewPassword(e.target.value)} className="w-full px-4 py-2 bg-[#ffffff10] text-white focus:outline-none mt-2" />
          </div>
        </div>

        <div>
          <label className="text-[#789FD6] text-sm">{t("confirm_password")}</label>
          <input type="password" placeholder={t("confirm_password")} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} className="w-full px-4 py-2 bg-[#ffffff10] text-white focus:outline-none mt-2" />
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div>
            ...
            <input type="password" placeholder={t("confirm_pin")} value={confirmPin} onChange={(e) => setConfirmPin(e.target.value)} className="w-full px-4 py-2 bg-[#ffffff10] text-white focus:outline-none mt-2" />
          </div>
        </div>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-[#000000ab] bg-opacity-50 z-10">
          <div className="bg-[#022a52] p-5 rounded-md shadow-lg text-white w-[40%]">
            ...
            <div className="flex justify-end space-x-2 mt-4">
              ...
              <button className="bg-[#789fd6] px-4 py-2 rounded" onClick={handleConfirmPin}>{t("confirm")}</button>
            </div>
          </div>
        </div>
      )}
