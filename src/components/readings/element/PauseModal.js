                ...
                <div className="grid grid-cols-1 gap-4 mb-4">
                    <div>
                        ...
                        <div className="flex w-full">
                            <div className="w-[50%]">
                                <input type="text" placeholder={t("write_here")} value={reactivationDate} onChange={(e) => setReactivationDate(e.target.value)} className="w-full px-4 py-2 bg-[#ffffff10] text-white focus:outline-none mt-2" />
                            </div>
