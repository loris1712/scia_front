            ...
            <div>
              ...
              <div className="px-4 py-4 rounded-lg flex items-center justify-between bg-[#e2d52d] gap-4 cursor-pointer" onClick={() => setScanning(true)}>
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-[#022a52] font-semibold">{t("move_or_add_spare")}</h2>
                </div>
              </div>
              ...
              <div className="flex items-center w-full my-6">
                ...
                <span className="px-6 text-white text-[16px] opacity-60">{t("or_search_by_code")}</span>
                <div className="flex-grow h-[2px] bg-white opacity-60"></div>
              </div>
              ...
              <div className="flex items-center w-full my-6">
                <div className="flex-grow h-[2px] bg-white opacity-60"></div>
                <span className="px-6 text-white text-[16px] opacity-60">{t("or_search_from_ESWBS")}</span>
                <div className="flex-grow h-[2px] bg-white opacity-60"></div>
              </div>

              <div className="grid grid-cols-1 gap-4 mb-4">
                <div className="flex flex-col">
                  <label className="text-[#789FD6] text-sm mb-2">{t("search_ESWBS")}</label>
                  <div
                    onClick={handleEswbsClick}
                    className="px-4 py-2 bg-[#ffffff10] text-white cursor-pointer focus:outline-none rounded-md"
                  >
                    {selectedEswbs || t("choose")}
                  </div>
                </div>
              </div>
